...
public class BoxNewBlink : DefaultSetPlaceSkill, IPunObservable
{
    ...
    public override void UseSkill()
    {
        ...
        gameObject.GetComponent<PhotonView>().RPC("BlinkAnimation", PhotonTargets.All);
    }
    ...
    void BlinkAnimation()
    {
        gameObject.GetComponent<Animator>().SetBool("isBlink",true);
    }
